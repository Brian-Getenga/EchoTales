# Generated by Django 5.2 on 2025-11-23 06:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(choices=[('html', 'HTML (TinyMCE)'), ('markdown', 'Markdown')], default='html', max_length=10)),
                ('content_html', tinymce.models.HTMLField(blank=True)),
                ('content_markdown', markdownx.models.MarkdownxField(blank=True)),
